				...
				<form onSubmit={handleLogin} className="flex flex-col gap-3 mt-4">
					...
					<div className="relative w-70">
						<input
							...
							className="w-full text-base px-0 py-[0.6rem] border-b-[#bbb] border-[none] border-b border-solid pr-10"
							onChange={(e) => {
						...
						<button
							type="button"
							className="absolute right-0 top-1/2 -translate-y-1/2 bg-transparent border-none cursor-pointer text-[#666] hover:text-[#333] p-1"
